...
function EmployerEditProfile() {
  ...
  const [employerDetails, setEmployerDetails] = useState<
    EmployerRegisterPayload | undefined
  >();
  ...
  useEffect(() => {
    if (employerDetails) {
      ...
      setValue("about", employerDetails?.about);
      setValue("experience", employerDetails?.experience);
      setValue("education", employerDetails?.education);
      // setValue("image", employerDetails?.image);
    ...
    <div>
      <div className="pl-1">
        <Breadcrumbs className="bg-white">
          ...
          <a href="/employer/profile" className="opacity-60">
            <span>Hồ sơ</span>
          </a>
