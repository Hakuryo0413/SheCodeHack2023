...
import { emailVerify } from "../../../features/axios/api/cofounder/cofounderAuthentication";
import { cofounderEmail } from "../../../features/redux/slices/cofounder/cofounderDetailsSlice";
...
function EmailVerify() {
  ...
  const handleSubmit = (e: any) => {
    ...
    emailVerify(email)
      .then(() => {
        // Handle the response
        dispatch(cofounderEmail(email));
        navigate("/cofounder/register/form");
      })
      .catch((error) => {
        // Handle the error
