...
import { cofounderRegisterValidationSchema } from "../../../utils/validation";
import { registerCofounder } from "../../../features/axios/api/cofounder/cofounderAuthentication";
import { CofounderRegisterPayload } from "../../../types/PayloadInterface";
import { useSelector } from "react-redux";
import { RootState } from "../../../features/redux/reducers/Reducer";

function CofounderRegister() {
  ...
  const {
    ...
    resolver: yupResolver(cofounderRegisterValidationSchema),
  });
  ...
  const submitHandler = async (formData: CofounderRegisterPayload) => {
    registerCofounder(formData)
      .then((response) => {
        notify("Registration success", "success");
        setTimeout(() => {
          navigate("/cofounder/login");
        }, 2000);
      })
      .catch((error: any) => {
