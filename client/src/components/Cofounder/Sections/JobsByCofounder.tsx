...
import deleteJob from "../../../features/axios/api/cofounder/deleteJob";
import { useDispatch } from "react-redux";
import { setCofounderJobId } from "../../../features/redux/slices/cofounder/cofounderJobDetailsSlice";
...
const JobsByCofounder: React.FC<AllJobsProps> = ({ jobs }) => {
  ...
  const handleViewJob = (jobId: string) => {
    dispatch(setCofounderJobId(jobId));
...
export default JobsByCofounder;
